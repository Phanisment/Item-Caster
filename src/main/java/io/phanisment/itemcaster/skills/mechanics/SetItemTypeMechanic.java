...
public class SetItemTypeMechanic implements ITargetedEntitySkill {
	private final EquipmentSlot slot;
	private final Material type;
	
	public SetItemTypeMechanic(MythicLineConfig config) {
		this.slot = EquipmentSlot.valueOf(config.getString(new String[]{"slot", "s"}, "HAND").toUpperCase());
		this.type = Material.valueOf(config.getString(new String[]{"type", "material", "t", "m"}, "STONE").toUpperCase());
	}
